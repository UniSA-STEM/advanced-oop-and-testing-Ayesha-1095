...
class Enclosure:
    ...
    Attributes:
        ...
        _animal_type (Animal subclass): The class of animal allowed in this enclosure.
    ...
    def __init__(self, size: str, environmental_type: str, animal_type: type[Animal], cleanliness_level: float = 0) -> None:
        """
        ...
        Args:
            ...
            cleanliness_level (float): Initial cleanliness level (default is 0).
        """
        # Basic property initialization
        self.__size: str = size
        self.__environmental_type: str = environmental_type
        self._animal_type = animal_type
        self.__cleanliness_level: float = cleanliness_level
        # Store animal instances that belong to this enclosure
        self.__animals: list = []
...
# ============================ Properties ================================================================
    ...
    animal_type = property(get_animal_type) # Read only
...
# ============================ Methods ====================================================================
    ...
    def clean_enclosure(self) -> str:
        ...
        # Check if the enclosure ius already clean
        if previous_level == 100:
            return f'The enclosure is already 100% cleaned.'
